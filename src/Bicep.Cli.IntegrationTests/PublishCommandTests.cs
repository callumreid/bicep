...
namespace Bicep.Cli.IntegrationTests
{
    ...
    public class PublishCommandTests : TestBase
    {
        ...
        {
            var settings = new InvocationSettings(BicepTestConstants.CreateFeaturesProvider(registryEnabled: true), BicepTestConstants.ClientFactory);
        ...
        public async Task Publish_ValidFile_ShouldSucceed(DataSet dataSet)
{
            ...
            var settings = new InvocationSettings(BicepTestConstants.CreateFeaturesProvider(registryEnabled: true), clientFactory.Object);
